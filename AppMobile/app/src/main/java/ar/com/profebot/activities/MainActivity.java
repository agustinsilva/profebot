...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((ImageView)findViewById(R.id.logo_id)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                Runnable r = new Runnable() {
                    @Override
                    public void run() {
                        builder.delete(0, builder.toString().length() - 1);
                        startActivity(new Intent(v.getContext(), AuxActivity.class));
                    }
                };

                if (builder.toString().equals("111")) {
